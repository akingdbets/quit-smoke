...
class _DashboardState extends State<Dashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    final cigarettesPerPack = widget.settings.cigarettesPerPack > 0 ? widget.settings.cigarettesPerPack : 20;
    final moneySaved = ((cigarettesNotSmoked / cigarettesPerPack) * widget.settings.pricePerPack).floor();
